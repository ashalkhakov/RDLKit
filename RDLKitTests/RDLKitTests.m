...
// Checks for RDLKit, one XCTest per area.
//
...
static RDLReport *RDLMiniInvoice(void) {
...
static NSString *RDLLaidText(RDLLaidOutItem *it) {
  return [it isKindOfClass:[RDLLaidOutTextbox class]] ? [(RDLLaidOutTextbox *)it text] : nil;
}

static NSString *RDLFixturesDirectory(void);
