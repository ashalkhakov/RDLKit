// PicaCanvasInteraction — the canvas's mouse and keyboard state machine.
//
// Fourteen ivars of transient gesture state used to live on PicaCanvasView
...
@interface PicaCanvasInteraction : NSObject
- (instancetype)initWithContext:(PicaEditingContext *)context hostView:(NSView *)hostView;
@property (nonatomic, weak) id<PicaCanvasInteractionHost> host;
