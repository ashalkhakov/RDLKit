// RDLExpressionHelper — completion for RDL `=` expressions, in the spirit of
...
// undoes the document.
@interface RDLExpressionFieldEditor : NSTextView
...
// `NSInteger *`.
#ifdef GNUSTEP
typedef int RDLCompletionIndex;
#else
typedef NSInteger RDLCompletionIndex;
#endif
