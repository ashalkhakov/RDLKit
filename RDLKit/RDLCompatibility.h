// RDLCompatibility.h — Cocoa / GNUstep shims. Pure ObjC, ARC.
#ifndef RDL_COMPATIBILITY_H
#define RDL_COMPATIBILITY_H

#import <Foundation/Foundation.h>
#import <AppKit/AppKit.h>

#ifndef RDL_COLOR
#define RDL_COLOR(r, g, b, a) \
  [NSColor colorWithCalibratedRed:(r) green:(g) blue:(b) alpha:(a)]
#endif

#ifndef RDL_UNUSED
#define RDL_UNUSED(x) (void)(x)
#endif

// RDL colours may be written as "#rrggbb" or as one of the .NET colour names,
// and real reports use both -- a sample asking for LightGrey should not come
// out black. Returns nil for a name we do not know, so the caller can fall
// back rather than paint something wrong.
static inline NSString *RDLHexForColorName(NSString *name) {
